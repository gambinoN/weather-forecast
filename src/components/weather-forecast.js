        ...
        <div id="background" className="absolute flex justify-center items-center flex-col w-full rounded-t-3xl bottom-0 h-[30%]">
          ...
          <div className="flex flex-row justify-around w-full">
            {weatherForecast.map((day, index) => {
              ...
              return (
                <div key={index} id="linear-forecast" className="h-[160px] w-[70px] rounded-[48px] flex flex-col bg-[#48319d] bg-opacity-[0.4] justify-evenly items-center">
          ...
          {hourlyData ? (
            <div className="flex flex-row justify-around w-full">
              {hourlyData.map((hour, index) => {
                ...
                return (
                  <div id="linear-forecast" key={index} className="h-[160px] w-[70px] rounded-[48px] flex flex-col z-10 bg-[#48319d] bg-opacity-[0.4] justify-evenly items-center">
